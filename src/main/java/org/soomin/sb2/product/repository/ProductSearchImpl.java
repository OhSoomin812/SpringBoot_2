...
import org.soomin.sb2.product.entities.QProductEntity;
import org.soomin.sb2.product.entities.QProductImage;
import org.soomin.sb2.product.entities.QProductReview;
...
public class ProductSearchImpl implements ProductSearch{
    ...
    @Override
    public PageResponseDTO<ProductListAllDTO> listAllQuerydsl(PageRequestDTO pageRequest) {
        QProductEntity qProductEntity = QProductEntity.productEntity;
        QProductImage qProductImage = QProductImage.productImage;
        QProductReview qProductReview = QProductReview.productReview;
...
//        });
        ...
        List<ProductListAllDTO> dtoList =   tupleList.stream().map(tuple -> {
            ...
            productListAllDTO.setImgName(imageNames);
