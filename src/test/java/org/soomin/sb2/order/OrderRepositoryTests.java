package org.soomin.sb2.order;

import lombok.extern.log4j.Log4j2;
import org.junit.jupiter.api.Test;
import org.soomin.sb2.order.entities.OrderDetailEntity;
import org.soomin.sb2.order.entities.OrderEntity;
import org.soomin.sb2.order.repository.OrderDetailEntityRepository;
import org.soomin.sb2.order.repository.OrderEntityRepository;
...
public class OrderRepositoryTests {
    ...
    public void testSelectOne() {
        OrderEntity order = repository.selectOne(1L);
    ...
    public void testOfCustomer(){
        ...
        Page<OrderEntity> page = repository.listOfUser(customer, pageable);
    ...
    public void testOfOrderAll(){
        ...
        Page<OrderEntity> page = repository.listOfUserOrder(customer, pageable);
